'''
    ...
    The original file contains a lot of configs for ResNet50, 
    also including `id2label` and `label2id` etc.
    
    Only label2id is used in this file. I added `crane2` to the original data.
'''
